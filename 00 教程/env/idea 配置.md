...
## 3.2 配置Maven环境
- Windows - General - Maven调整installations和User Settings位置即可
...
- 复制 jrebel6/jrebel.jar 文件到 eclipse根目录下的  /plugins/org.zeroturnaround.eclipse.embedder6.4.3.RELEASE-201511061610/jr6/jrebel/ 目录，覆盖原 jrebel.jar 文件
- 复制 jrebel.lic 文件到当前用户目录的 /.jrebel 下
- 打开 eclipse 的 Jrebel Configuration 视图，打开 Advanced - 选择Jrebel6 Agent，重启eclipse
- 重装后，若没有更改 eclipse 配置，则无需设置，但需要复制 jrebel.lic 到用户路径下

**Hibernate插件**
- [Hibernate插件参考链接](https://jingyan.baidu.com/article/295430f1d7ac830c7f00507d.html):
