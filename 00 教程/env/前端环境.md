...
stylelint 主要用于检查 cssless/sass 文件的语法规范，首先执行 `npm install --save-dev stylelint stylelint-config-standard stylelint-config-prettier` 引入必备依赖，包括自身依赖以及和 prettier 整合依赖。
