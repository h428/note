...
CREATE TABLE `base_user`  (
  ...
  `is_allow_add` bit(1) NOT NULL DEFAULT b'1' COMMENT '允许添加',
  `is_allow_auth` bit(1) NOT NULL DEFAULT b'1' COMMENT '允许将认证信息供仓库用户使用',
  `is_allow_message` bit(1) NOT NULL DEFAULT b'1' COMMENT '允许站内信',
...
-- ----------------------------
-- Table structure for hub_buy_apply
-- ----------------------------
DROP TABLE IF EXISTS `hub_buy_apply`;
CREATE TABLE `hub_buy_apply`  (
  `id` bigint(20) NOT NULL COMMENT 'id',
...
CREATE TABLE `lab`  (
  ...
  `belong_user_id` bigint(20) NOT NULL COMMENT '所属用户 id',
  `create_user_id` bigint(20) NOT NULL COMMENT '创建用户 id',
  `create_time` bigint(20) NOT NULL DEFAULT 0 COMMENT '创建时间',
  `update_user_id` bigint(20) NOT NULL COMMENT '更新用户 id',
  `update_time` bigint(20) NOT NULL DEFAULT 0 COMMENT '最后更新时间',
  `hand_over_user_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '移交用户 id',
  `hand_over_time` bigint(20) NOT NULL DEFAULT 0 COMMENT '最后移交时间',
  `status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '状态',
  `is_allow_apply` bit(1) NOT NULL DEFAULT b'1' COMMENT '允许申请',
  `is_deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  `delete_time` bigint(20) NOT NULL DEFAULT 0 COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_belong_user_id`(`belong_user_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '仓库' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for lab_apply_back
-- ----------------------------
DROP TABLE IF EXISTS `lab_apply_back`;
CREATE TABLE `lab_apply_back`  (
  `id` bigint(20) NOT NULL COMMENT 'id',
  `origin_id` bigint(20) NOT NULL COMMENT '入库时分配的唯一id',
  `spec_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '每件规格品消耗后生成的 id',
  `num` int(11) NOT NULL COMMENT '数量',
  `is_apply` bit(4) NOT NULL DEFAULT b'1' COMMENT '是否申请操作，默认为 1 ，表示是申请操作',
  ...
  `op_lab_shelf_id` bigint(20) NOT NULL COMMENT '发起操作的架子',
  `another_lab_shelf_id` bigint(20) NOT NULL COMMENT '与操作相关的另一个架子',
  `op_lab_user_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '冗余列，发起操作的用户，优化查询',
  `another_lab_user_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '冗余列，与操作相关的另一个用户，优化查询',
  ...
  INDEX `idx_origin_id_and_op_time`(`origin_id`, `op_time`) USING BTREE,
  INDEX `idx_op_hub_user_id_and_op_time`(`op_lab_user_id`, `op_time`) USING BTREE,
  INDEX `idx_another_hub_user_id_and_op_time`(`another_lab_user_id`, `op_time`) USING BTREE,
...
CREATE TABLE `lab_inventory`  (
  ...
  `origin_id` bigint(20) NOT NULL COMMENT '入库或首次申请时分配到的id',
  `spec_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '每件规格品消耗后生成的 id',
  `num` int(11) NOT NULL COMMENT '数量',
  `spec_num` int(11) NOT NULL DEFAULT 0 COMMENT '规格数量',
  `lab_id` bigint(20) NOT NULL COMMENT '所属仓库',
  `lab_item_id` bigint(20) NOT NULL COMMENT '物品 id',
...
CREATE TABLE `lab_item`  (
  ...
  `item_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '货号',
  `cas` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'cas 编号',
  `is_floated` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否支持浮点数操作',
  `update_lab_user_id` bigint(20) NOT NULL COMMENT '更新用户',
  `update_time` bigint(20) NOT NULL COMMENT '更新时间',
  `lab_id` bigint(20) NOT NULL COMMENT '所属仓库',
  `spec_num` int(11) NOT NULL DEFAULT 0 COMMENT '规格品的规格量，0 表示非规格品',
  `spec_unit` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '规格品单位',
...
-- ----------------------------
-- Table structure for lab_permission
-- ----------------------------
...
CREATE TABLE `lab_role`  (
  ...
  `desc_info` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '描述信息',
  `lab_permissions` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '权限列表，使用 , 分隔',
...
CREATE TABLE `lab_user`  (
  ...
  `lab_permissions` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '用户额外权限',
